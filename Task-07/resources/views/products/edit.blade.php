...
<head>
    ...
    <title>Edit Product | Cosmetics Management</title>
...
<div class="container">
    ...
    <header class="header">
        <div class="header-content">
            <div class="brand">
                ...
                <p class="tagline">Update your cosmetic product information</p>
            </div>
    ...
    <main class="main-content">
        ...
        <div class="form-header">
            <div>
                ...
                <p class="form-subtitle">Modify the details of your cosmetic product</p>
            </div>
        ...
        <div class="owner-info">
            ...
            <div class="owner-details">
                <h4>Product Owner: {{ $product->user->name }}</h4>
                <p>Created on {{ $product->created_at->format('M d, Y') }}</p>
            </div>
        </div>
        @endif
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" class="form-container">
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-description">Update the basic details of your cosmetic product</p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <span class="form-hint">Provide detailed information about your product</span>
                    @error('description')
                        <div class="error">
                            <i class="fas fa-exclamation-circle"></i> {{ $message }}
                        </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-description">Update pricing and inventory details</p>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <span class="form-hint">Current inventory count</span>
                        @error('stock')
                            <div class="error">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                            </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-description">Manage supplier information for this product</p>
                    </div>
                </div>
                ...
                <div class="suppliers-section">
                    ...
                    <div id="suppliers-container">
                        @php
                            $supplierCount = 0;
                            $existingSuppliers = $product->suppliers ?? collect();
                        @endphp
                        
                        @if($existingSuppliers->count() > 0)
                            @foreach($existingSuppliers as $supplier)
                                @php $supplierCount++; @endphp
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   step="0.01"
                                                   min="0"
                                                   value="{{ old('suppliers.' . $supplierCount . '.cost_price', $supplier->pivot->cost_price ?? '') }}">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" 
                                                   ...
                                                   placeholder="0"
                                                   min="0"
                                                   value="{{ old('suppliers.' . $supplierCount . '.lead_time_days', $supplier->pivot->lead_time_days ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        @else
                            ...
                            <div class="supplier-item" id="supplier-1">
                                <div class="supplier-header">
                                    <div class="supplier-title">
                                        <i class="fas fa-truck"></i>
                                        Supplier #1
                                    </div>
                                    <button type="button" class="remove-supplier" onclick="removeSupplier(1)">
                                        <i class="fas fa-times"></i>
                                    </button>
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
                                        <label for="suppliers[1][supplier_id]" class="form-label">
                                            Supplier <span class="required">*</span>
                                        </label>
                                        <select name="suppliers[1][supplier_id]" class="form-control" required>
                                            <option value="">Select supplier</option>
                                    ...
                                    <div class="form-group">
                                        <label for="suppliers[1][cost_price]" class="form-label">
                                            Cost Price ($)
                                        </label>
                                        <input type="number" 
                                               name="suppliers[1][cost_price]" 
                                               class="form-control" 
                                               placeholder="0.00"
                                               step="0.01"
                                               min="0">
                                    ...
                                    <div class="form-group">
                                        <label for="suppliers[1][lead_time_days]" class="form-label">
                                            Lead Time (Days)
                                        </label>
                                        <input type="number" 
                                               name="suppliers[1][lead_time_days]" 
                                               class="form-control" 
                                               placeholder="0"
                                               min="0">
                                    </div>
                    ...
                    <button type="button" id="add-supplier-btn" class="add-supplier-btn">
                        <i class="fas fa-plus"></i> Add Another Supplier
                    </button>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('products.show', $product) }}" class="cancel-link">
                    Cancel and view product
                </a>
            </div>
        </form>
    ...
    <footer class="footer">
        <div class="footer-info">
            ...
            <div class="footer-badge">
                <i class="fas fa-info-circle"></i>
                <span>Last Updated: {{ $product->updated_at->diffForHumans() }}</span>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    let supplierCount = {{ $supplierCount ?? 1 }};
